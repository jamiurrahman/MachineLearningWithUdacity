...
if len(cleaned_data) > 0:
    ...
    try:
        ...
        # working with score (r-squared score)
        # r-squared score for training data is not useful
        print("r-squared score for training data after cleaned data : ", reg.score(ages_train, net_worths_train))

        # r-squared score for testing data is very useful
        print("r-squared score for testing data after cleaned data : ", reg.score(ages_test, net_worths_test))
    except NameError:
